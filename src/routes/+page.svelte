  ...
  {:else}
    ...
    {:else if files.length === 0}
      ...
      >
        ...
        <div class="drop-icon">
          <svg width="56" height="56" viewBox="0 0 1172 858" fill="none">
